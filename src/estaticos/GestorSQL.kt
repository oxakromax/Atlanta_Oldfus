...
//            Thread.sleep(1000)
    ...
    fun ES_IP_BANEADA(ip: String): Boolean {
        ...
        try {
            val resultado = consultaSQL(consultaSQL, _bdCuentas!!)
            if (resultado.first()) {
                b = true
            }
            cerrarResultado(resultado)
    ...
    fun LISTA_BAN_IP(): String {
        ...
        try {
            val resultado = consultaSQL("SELECT `ip` FROM `banip`;", _bdCuentas!!)
    ...
    fun INSERT_BAN_IP(ip: String): Boolean {
        ...
        try {
            val declaracion = transaccionSQL(consultaSQL, _bdCuentas!!)
    ...
    fun GET_VREFERIDOS_CUENTA_POR_IP(Ip: String): Int {
        ...
        try {
            val resultado = consultaSQL(consultaSQL, _bdDinamica!!)
            if (resultado.first()) {
    ...
    fun SET_VERIFICADOR_REFERIDO(i: Int, ip: String) {
        ...
        try {
            val declaracion = transaccionSQL(consultaSQL, _bdDinamica!!)
            ejecutarTransaccion(declaracion)
            cerrarDeclaracion(declaracion)
        } catch (e: Exception) {
            exceptionModify(e, consultaSQL, "")
    ...
    fun RESTAR_OGRINAS(cuenta: Cuenta, restar: Long, perso: Personaje?): Boolean {
        ...
        try {
            ...
            exceptionNormal(e, "RESTAR OGRINAS A " + cuenta.nombre + ", OGRINAS " + restar + ", LE RESTO? " + resto)
        }
    ...
    fun RESTAR_CREDITOS(cuenta: Cuenta, restar: Long, perso: Personaje): Boolean {
        ...
        try {
            ...
            exceptionNormal(e, "RESTAR CREDITOS A " + cuenta.nombre + ", CREDITOS " + restar + ", LE RESTO? " + resto)
        }
    ...
    fun CARGAR_CUENTA_POR_ID(id: Int) {
        ...
        try {
            ...
            val resultado = consultaSQL(consultaSQL, _bdCuentas!!)
            if (resultado.first()) {
                val cuenta = Cuenta(resultado.getInt("id"), resultado.getString("cuenta"), resultado.getInt("referido"))
    ...
    fun CARGAR_DB_CUENTAS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `cuentas`;", _bdCuentas!!)
            while (resultado.next()) {
                val cuenta = Cuenta(resultado.getInt("id"), resultado.getString("cuenta"), resultado.getInt("referido"))
                Mundo.addCuenta(cuenta)
            }
    ...
    fun CARGAR_CAPTCHAS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `captchas`;", _bdCuentas!!)
            while (resultado.next()) {
    ...
    fun GET_ULTIMO_SEGUNDOS_VOTO(ip: String, cuentaID: Int): Long {
        ...
        try {
            var resultado = consultaSQL(consultaSQL, _bdCuentas!!)
            while (resultado.next()) {
                try {
    ...
    fun CARGAR_CUENTAS_SERVER_PERSONAJE() {
        try {
            val resultado = consultaSQL("SELECT * FROM `cuentas_servidor`;", _bdDinamica!!)
            while (resultado.next()) {
                try {
    ...
    fun INSERT_TOKEN(cuenta: Cuenta, token: String) {
        ...
        try {
            val declaracion = _bdDinamica?.let { transaccionSQL(consultaSQL, it) } ?: return
    ...
    fun GET_SIG_ID_OBJETO(): Int {
        var id = 1
        try {
            val resultado = consultaSQL("SELECT MAX(id) AS max FROM `objetos`;", _bdDinamica!!)
            if (resultado.first()) {
    ...
    fun CARGAR_RECETAS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `recetas`;", _bdEstatica!!)
            while (resultado.next()) {
    ...
    fun CARGAR_DROPS(): Int {
        ...
        try {
            if (!AtlantaMain.PARAM_SISTEMA_ORBES) {
                val resultado = consultaSQL("SELECT * FROM `drops`;", _bdEstatica!!)
                while (resultado.next()) {
                    if (Mundo.getObjetoModelo(resultado.getInt("objeto")) == null) {
                        continue
                    }
                    val drop = DropMob(
                        resultado.getInt("objeto"), resultado.getInt("prospeccion"), resultado.getFloat(
                            "porcentaje"
                        ), resultado.getInt("max"), resultado.getString("condicion")
                    )
    ...
    fun CARGAR_DROPS_FIJOS(): Int {
        var numero = 0
        try {
            val resultado = consultaSQL("SELECT * FROM `drops_fijos`;", _bdEstatica!!)
            while (resultado.next()) {
                if (Mundo.getObjetoModelo(resultado.getInt("objeto")) == null) {
                    continue
                }
                Mundo.addDropFijo(
                    DropMob(
                        resultado.getInt("objeto"), resultado.getFloat("porcentaje"), resultado.getInt(
                            "nivelMin"
    ...
    fun SELECT_ZONAS() {
        try {
            val resultado = consultaSQL("SELECT * FROM zonas;", _bdEstatica!!)
            while (resultado.next()) {
    ...
    fun CARGAR_OBJETOS_SETS() {
        try {
            ...
            while (resultado.next()) {
                val set = ObjetoSet(
                    resultado.getInt("id"), resultado.getString("nombre"), resultado.getString(
                        "objetos"
                    )
                )
                for (i in 2..8) {
    ...
    fun CARGAR_CERCADOS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `cercados_modelo`;", _bdEstatica!!)
            while (resultado.next()) {
    ...
    fun CARGAR_OFICIOS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `oficios`;", _bdEstatica!!)
            while (resultado.next()) {
                Mundo.addOficio(
                    Oficio(
                        resultado.getInt("id"), resultado.getString("herramientas"), resultado.getString(
                            "recetas"
                        )
                    )
                )
    ...
    fun CARGAR_SERVICIOS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `servicios`;", _bdEstatica!!)
            while (resultado.next()) {
                Mundo.addServicio(
                    Servicio(
                        resultado.getInt("id"),
    ...
    fun CARGAR_ENCARNACIONES_MODELOS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `encarnaciones_modelo`;", _bdEstatica!!)
            while (resultado.next()) {
    ...
    fun CARGAR_CLASES() {
        try {
            val resultado = consultaSQL("SELECT * FROM `clases`;", _bdEstatica!!)
            while (resultado.next()) {
                val clase = Clase(
                    resultado.getInt("id"),
    ...
    fun CARGAR_CREA_OBJETOS_MODELOS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `crear_objetos_modelos`;", _bdEstatica!!)
            while (resultado.next()) {
                val creaTuItem = CreaTuItem(
                    resultado.getInt("id"), resultado.getString("statsMaximos"), resultado
    ...
    fun CARGAR_CREA_OBJETOS_PRECIOS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `crear_objetos_stats`;", _bdEstatica!!)
            while (resultado.next()) {
    ...
    fun CARGAR_AREA() {
        try {
            val resultado = consultaSQL("SELECT * FROM `areas`;", _bdEstatica!!)
            while (resultado.next()) {
                val area = Area(
                    resultado.getShort("id").toInt(), resultado.getShort("superarea"), resultado.getString(
                        "nombre"
                    )
                )
                Mundo.addArea(area)
    ...
    fun CARGAR_SUBAREA() {
        try {
            val resultado = consultaSQL("SELECT * FROM `subareas`;", _bdEstatica!!)
            while (resultado.next()) {
                val subarea = SubArea(
                    resultado.getShort("id").toInt(), resultado.getShort("area"), resultado.getString(
                        "nombre"
                    ), resultado.getInt("conquistable") == 1, resultado.getInt("minNivelGrupoMob"), resultado.getInt(
                        "maxNivelGrupoMob"
    ...
    fun CARGAR_NPCS(): Int {
        var numero = 0
        try {
            val resultado = consultaSQL("SELECT * FROM `npcs_ubicacion`;", _bdEstatica!!)
            while (resultado.next()) {
                try {
    ...
    fun CARGAR_CASAS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `casas_modelo`;", _bdEstatica!!)
            while (resultado.next()) {
    ...
    fun RECARGAR_CASAS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `casas`;", _bdDinamica!!)
            while (resultado.next()) {
                try {
                    Mundo.getCasa(resultado.getInt("id"))?.actualizarCasa(
                        resultado.getInt("dueño"), resultado.getInt("precio").toLong(),
    ...
    fun CARGAR_COFRES() {
        try {
            val resultado = consultaSQL("SELECT * FROM `cofres_modelo`;", _bdEstatica!!)
            while (resultado.next()) {
                Mundo.addCofre(
                    Cofre(
                        resultado.getInt("id"), resultado.getInt("casa"), resultado.getShort("mapa"), resultado
                            .getShort("celda"), AtlantaMain.LIMITE_OBJETOS_COFRE
                    )
                )
            }
            cerrarResultado(resultado)
    ...
    fun CARGAR_EXPERIENCIA() {
        try {
            val resultado = consultaSQL("SELECT * FROM `experiencia`;", _bdEstatica!!)
            var maxAlineacion = 0
            var maxPersonaje = 0
            var maxGremio = 0
            var maxOficio = 0
            ...
            while (resultado.next()) {
                ...
                val exp = Experiencia(
                    resultado.getLong("personaje"), resultado.getInt("oficio"), resultado.getInt(
                        "dragopavo"
                    ), resultado.getLong("gremio"), resultado.getInt("pvp"), resultado.getInt("encarnacion")
                )
    ...
    fun CARGAR_TRIGGERS(): Int {
        var numero = 0
        try {
            val resultado = consultaSQL("SELECT * FROM `celdas_accion`;", _bdEstatica!!)
            while (resultado.next()) {
    ...
    fun CARGAR_MOBS_EVENTO() {
        try {
            val resultado = consultaSQL("SELECT * FROM `mobs_evento`;", _bdEstatica!!)
            while (resultado.next()) {
                Mundo.addMobEvento(
    ...
    fun CARGAR_PERSONAJES() {
        try {
            val resultado = consultaSQL("SELECT * FROM `personajes`;", _bdDinamica!!)
            while (resultado.next()) {
    ...
    fun CARGAR_PRISMAS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `prismas`;", _bdDinamica!!)
            while (resultado.next()) {
    ...
    fun SELECT_OBJETOS_MERCADILLO(): Int {
        var num = 0
        try {
            val resultado = consultaSQL("SELECT * FROM `mercadillo_objetos`;", _bdDinamica!!)
            while (resultado.next()) {
    ...
    fun CARGAR_RECAUDADORES() {
        var numero = 0
        try {
            val resultado = consultaSQL("SELECT * FROM `recaudadores`;", _bdDinamica!!)
            while (resultado.next()) {
                val mapa = Mundo.getMapa(resultado.getShort("mapa")) ?: continue
    ...
    fun CARGAR_GREMIOS() {
        try {
            val resultado = consultaSQL("SELECT * FROM gremios;", _bdDinamica!!)
            while (resultado.next()) {
                Mundo.addGremio(
                    Gremio(
                        resultado.getInt("id"),
    ...
    fun CLONAR_MAPA(
        ...
        try {
            var i = 1
            val declaracion = transaccionSQL(consultaSQL, _bdEstatica!!)
            ...
            val resultado = consultaSQL(consultaSQL, _bdEstatica!!)
            while (resultado.next()) {
    ...
    fun CARGAR_MAPAS_IDS(ids: String) {
        ...
        try {
            val resultado = consultaSQL("SELECT * FROM `mapas` WHERE `id` IN ($ids) ;", _bdEstatica!!)
            var mapa: Mapa
            while (resultado.next()) {
                if (Mundo.mapaExiste(resultado.getShort("id"))) {
                    continue
    ...
    fun CARGAR_MOBS_FIJOS(): Int {
        ...
        try {
            ...
            while (resultado.next()) {
                ...
                if (mapa.getCelda(resultado.getShort("celda")) == null) {
                    AtlantaMain.redactarLogServidorln(
                        "LA CELDA " + resultado.getShort("celda") + " DEL MAPA " + resultado
    ...
    fun SELECT_ANIMACIONES() {
        try {
            val resultado = consultaSQL("SELECT * FROM `animaciones`;", _bdEstatica!!)
            while (resultado.next()) {
                Mundo.addAnimacion(
                    Animacion(
                        resultado.getInt("id"), resultado.getInt("hechizoAnimacion"), resultado.getInt(
                            "tipoDisplay"
                        ), resultado.getInt("spriteAnimacion"), resultado.getInt("level"), resultado.getInt("duracion"),
                        resultado.getInt("talla")
                    )
                )
            }
    ...
    fun CARGAR_COMANDOS_MODELO() {
        try {
            val resultado = consultaSQL("SELECT * FROM `comandos_modelo`;", _bdEstatica!!)
            while (resultado.next()) {
    ...
    fun CARGAR_OTROS_INTERACTIVOS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `otros_interactivos`;", _bdEstatica!!)
            while (resultado.next()) {
    ...
    fun CARGAR_COMIDAS_MASCOTAS(): Int {
        var numero = 0
        try {
            val resultado = consultaSQL("SELECT * FROM `mascotas_modelo`;", _bdEstatica!!)
            while (resultado.next()) {
    ...
    fun CARGAR_HECHIZOS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `hechizos`;", _bdEstatica!!)
            while (resultado.next()) {
                val id = resultado.getInt("id")
                val hechizo = Hechizo(
                    id, resultado.getString("nombre"), resultado.getInt("sprite"), resultado
    ...
    fun CARGAR_ESPECIALIDADES() {
        try {
            val resultado = consultaSQL("SELECT * FROM `especialidades`;", _bdEstatica!!)
            while (resultado.next()) {
                Mundo.addEspecialidad(
                    Especialidad(
                        resultado.getInt("id"), resultado.getInt("orden"), resultado.getInt(
                            "nivel"
    ...
    fun CARGAR_DONES_MODELOS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `dones`;", _bdEstatica!!)
            while (resultado.next()) {
    ...
    fun CARGAR_OBJETOS_MODELOS() {
        try {
            var maxID = 0
            val resultado = consultaSQL("SELECT * FROM `objetos_modelo`;", _bdEstatica!!)
            while (resultado.next()) {
            ...
            AtlantaMain.MAX_ID_OBJETO_MODELO = min(maxID, AtlantaMain.MAX_ID_OBJETO_MODELO)
            cerrarResultado(resultado)
        } catch (e: Exception) {
            exceptionExit(e)
        }
    ...
    fun CARGAR_MONTURAS_MODELOS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `monturas_modelo`;", _bdEstatica!!)
            while (resultado.next()) {
                Mundo.addMonturaModelo(
                    MonturaModelo(
                        resultado.getInt("id"), resultado.getString("stats"), resultado
    ...
    fun CARGAR_MOBS_MODELOS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `mobs_modelo`;", _bdEstatica!!)
            while (resultado.next()) {
                ...
                val grados = resultado.getString("grados").replace(" ".toRegex(), "").replace(",g".toRegex(), "g")
    ...
    fun CARGAR_MOBS_RAROS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `mobs_raros`;", _bdEstatica!!)
            while (resultado.next()) {
    ...
    fun CARGAR_MIEMBROS_GREMIO(): Int {
        var numero = 0
        try {
            val resultado = consultaSQL("SELECT * FROM miembros_gremio;", _bdDinamica!!)
            while (resultado.next()) {
                ...
                gremio.addMiembro(
                    resultado.getInt("id"), resultado.getInt("rango"), resultado.getLong("xpDonada"), resultado
    ...
    fun CARGAR_MONTURAS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `monturas`;", _bdDinamica!!)
            while (resultado.next()) {
                Mundo.addMontura(
                    Montura(
                        resultado.getInt("id"),
    ...
    fun CARGAR_NPC_MODELOS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `npcs_modelo`;", _bdEstatica!!)
            while (resultado.next()) {
                val id = resultado.getInt("id")
    ...
    fun CARGAR_MISION_OBJETIVOS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `mision_objetivos`;", _bdEstatica!!)
            while (resultado.next()) {
    ...
    fun CARGAR_ORNAMENTOS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `ornamentos`;", _bdEstatica!!)
            while (resultado.next()) {
                val o = Ornamento(
                    resultado.getInt("id"),
                    resultado.getString("nombre"),
    ...
    fun CARGAR_TITULOS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `titulos`;", _bdEstatica!!)
            while (resultado.next()) {
                val o = Titulo(
                    resultado.getInt("id"),
                    resultado.getString("nombre"),
    ...
    fun CARGAR_ZAAPS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `zaaps`;", _bdEstatica!!)
            while (resultado.next()) {
    ...
    fun CARGAR_PREGUNTAS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `npc_preguntas`;", _bdEstatica!!)
            while (resultado.next()) {
                Mundo.addPreguntaNPC(
                    PreguntaNPC(
                        resultado.getInt("id"), resultado.getString("respuestas"), resultado
    ...
    fun CARGAR_RESPUESTAS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `npc_respuestas`;", _bdEstatica!!)
            while (resultado.next()) {
                val id = resultado.getInt("id")
    ...
    fun CARGAR_ACCION_FINAL_DE_PELEA(): Int {
        var numero = 0
        try {
            val resultado = consultaSQL("SELECT * FROM `accion_pelea`;", _bdEstatica!!)
            while (resultado.next()) {
                val mapa = Mundo.getMapa(resultado.getShort("mapa")) ?: continue
                val accion = Accion(
                    resultado.getInt("accion"), resultado.getString("args"), resultado.getString(
                        "condicion"
                    )
                )
    ...
    fun CARGAR_ACCIONES_USO_OBJETOS(): Int {
        var numero = 0
        try {
            val resultado = consultaSQL("SELECT * FROM `objetos_accion`;", _bdEstatica!!)
            while (resultado.next()) {
    ...
    fun CARGAR_TUTORIALES() {
        try {
            val resultado = consultaSQL("SELECT * FROM `tutoriales`;", _bdEstatica!!)
            while (resultado.next()) {
                val id = resultado.getInt("id")
                val inicio = resultado.getString("inicio")
                val recompensa = (resultado.getString("recompensa1") + "$" + resultado.getString("recompensa2") + "$"
    ...
    fun CARGAR_INTERACTIVOS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `objetos_interactivos`;", _bdEstatica!!)
            while (resultado.next()) {
    ...
    fun RECARGAR_CERCADOS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `cercados`;", _bdDinamica!!)
            while (resultado.next()) {
                try {
    ...
    fun RECARGAR_COFRES() {
        try {
            val resultado = consultaSQL("SELECT * FROM `cofres`;", _bdDinamica!!)
            while (resultado.next()) {
                try {
            ...
            while (resultado.next()) {
                try {
                    Mundo.addObjetoTrueque(
                        resultado.getInt("idObjeto"), resultado.getString("necesita"), resultado.getInt(
                            "prioridad"
    ...
    fun CARGAR_ALMANAX() {
        try {
            val resultado = consultaSQL("SELECT * FROM `almanax`;", _bdEstatica!!)
            while (resultado.next()) {
                try {
                    ...
                    Mundo.addAlmanax(
                        Almanax(
                            resultado.getInt("id"), resultado.getInt("tipo"), resultado.getInt("bonus"),
    ...
    fun CARGAR_MISIONES() {
        try {
            val resultado = consultaSQL("SELECT * FROM `misiones`;", _bdEstatica!!)
            while (resultado.next()) {
    ...
    fun SELECT_PUESTOS_MERCADILLOS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `mercadillos`;", _bdEstatica!!)
            while (resultado.next()) {
    ...
    fun CARGAR_ETAPAS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `mision_etapas`;", _bdEstatica!!)
            while (resultado.next()) {
                Mundo.addEtapa(
                    resultado.getInt("id"), resultado.getString("recompensas"), resultado.getString("objetivos"),
                    resultado.getString("nombre")
                )
            }
            cerrarResultado(resultado)
    ...
    fun CARGAR_MAPAS_ESTRELLAS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `mapas_estrellas`;", _bdDinamica!!)
            while (resultado.next()) {
                try {
    ...
    fun CARGAR_OBJETOS() {
        try {
            val resultado = consultaSQL("SELECT * FROM `objetos`;", _bdDinamica!!)
            while (resultado.next()) {
    ...
    fun SELECT_RANKING_KOLISEO() {
        try {
            val resultado = consultaSQL("SELECT * FROM `ranking_koliseo`;", _bdDinamica!!)
            while (resultado.next()) {
                Mundo.addRankingKoliseo(
                    RankingKoliseo(
                        resultado.getInt("id"), resultado.getString("nombre"), resultado
    ...
    fun SELECT_RANKING_PVP() {
        try {
            val resultado = consultaSQL("SELECT * FROM `ranking_pvp`;", _bdDinamica!!)
            while (resultado.next()) {
                Mundo.addRankingPVP(
                    RankingPVP(
                        resultado.getInt("id"), resultado.getString("nombre"), resultado.getInt(
                            "victorias"
                        ), resultado.getInt("derrotas"), resultado.getInt("nivelAlineacion")
                    )
                )
            }
            cerrarResultado(resultado)
    ...
    fun CARGAR_MAPAS_HEROICO() {
        try {
            val resultado = consultaSQL("SELECT * FROM `mapas_heroico`;", _bdDinamica!!)
            while (resultado.next()) {
                try {
                    Mundo.addMapaHeroico(
                        resultado.getShort("mapa"), resultado.getString("mobs"), resultado.getString("objetos"),
    ...
    fun REPLACE_IP_AUTORIZADA(cuenta: Cuenta, auth: Boolean) {
        ...
        try {
            ...
            ejecutarTransaccion(declaracion)
            cerrarDeclaracion(declaracion)
            INSERT_IP_AUTORIZADA(cuenta, auth) // vuelta weona que me di, era con update pero me da paja solucionarlo
        } catch (e: Exception) {
            exceptionModify(e, consultaSQL, "")
        }
    }
    ...
    fun VACIAR_MAPAS_ESTRELLAS() {
        try {
            val declaracion = transaccionSQL("TRUNCATE `mapas_estrellas`;", _bdDinamica!!)
            ejecutarTransaccion(declaracion)
            cerrarDeclaracion(declaracion)
        } catch (e: Exception) {
            exceptionNormal(e, "")
    ...
    fun VACIAR_MAPAS_HEROICO() {
        try {
            val declaracion = transaccionSQL("TRUNCATE `mapas_heroico`;", _bdDinamica!!)
            ejecutarTransaccion(declaracion)
            cerrarDeclaracion(declaracion)
        } catch (e: Exception) {
            exceptionNormal(e, "")
    ...
    fun REPLACE_CERCADO(cercado: Cercado) {
        ...
        try {
            var declaracion = transaccionSQL(consultaSQL, _bdDinamica!!)
    ...
    fun GET_MENSAJE_PENDIENTE(p: Personaje) {
        ...
        try {
            try {
                val resultado = consultaSQL(consultaSQL, _bdDinamica!!)
                while (resultado.next()) {
                    GestorSalida.ENVIAR_Im1223_MENSAJE_IMBORRABLE(p, resultado.getString("mensaje"))
                }
    ...
    fun QUERY_ESTATICA(query: String) {
        try {
            val declaracion = transaccionSQL(query, _bdEstatica!!)
            ejecutarTransaccion(declaracion)
            cerrarDeclaracion(declaracion)
        } catch (e: Exception) {
            e.toString()
    ...
    fun QUERY_DINAMICA(query: String) {
        try {
            val declaracion = transaccionSQL(query, _bdDinamica!!)
            ejecutarTransaccion(declaracion)
            cerrarDeclaracion(declaracion)
        } catch (e: Exception) {
            e.toString()
    ...
    fun QUERY_CUENTAS(query: String) {
        try {
            val declaracion = transaccionSQL(query, _bdCuentas!!)
            ejecutarTransaccion(declaracion)
            cerrarDeclaracion(declaracion)
        } catch (e: Exception) {
            e.toString()
    ...
    fun QUERY_ALTERNA(query: String) {
        try {
            val declaracion = transaccionSQL(query, _bdAlterna!!)
            ejecutarTransaccion(declaracion)
            cerrarDeclaracion(declaracion)
        } catch (e: Exception) {
            e.toString()
    ...
    fun REPLACE_ACCIONES_RESPUESTA(
        ...
        try {
            var declaracion = transaccionSQL(consultaSQL, _bdEstatica!!)
    ...
    fun GET_NUEVA_FECHA_KEY(mapa: Short): String {
        ...
        try {
            ...
            while (resultado.next()) {
                try {
                    str =
                        resultado.getString("fecha") + "|" + resultado.getString("key") + "|" + resultado.getString("mapData")
                } catch (ignored: Exception) {
                }
    ...
    fun CARGAR_LIVE_ACTION() {
        try {
            val resultado = consultaSQL("SELECT * FROM `live_action`;", _bdDinamica!!)
            while (resultado.next()) {
    ...
    fun GET_OGRINAS_TOTALES(): Int {
        ...
        try {
            var resultado =
                _bdCuentas?.let { consultaSQL("SELECT SUM(ogrinas) AS total FROM cuentas WHERE rango = 0", it) }
                    ?: return 0
            while (resultado.next()) {
    ...
    fun GET_LISTA_REPORTES(cuenta: Cuenta): String {
        ...
        try {
            var resultado: ResultSet =
                consultaSQL("SELECT * FROM `reporte_bugs` LIMIT " + AtlantaMain.LIMITE_REPORTES + ";", _bdDinamica!!)
            var str2 = StringBuilder()
            while (resultado.next()) {
                if (str2.isNotEmpty()) {
                    str2.append("#")
                }
                str2.append(resultado.getInt("id")).append(";").append(resultado.getString("perso")).append(";")
                    .append(resultado.getString("asunto")).append(";").append(resultado.getString("fecha")).append(";")
                    .append(
            ...
            cerrarResultado(resultado)
            resultado =
                consultaSQL("SELECT * FROM `sugerencias` LIMIT " + AtlantaMain.LIMITE_REPORTES + ";", _bdDinamica!!)
            str2 = StringBuilder()
            while (resultado.next()) {
                if (str2.isNotEmpty()) {
                    str2.append("#")
                ...
                str2.append(resultado.getInt("id")).append(";").append(resultado.getString("perso")).append(";")
                    ...
                    .append(
                        if (cuenta.tieneReporte(
                                Constantes.REPORTE_SUGERENCIAS, resultado
                                    .getInt("id")
                            )
                        )
                            1
            ...
            cerrarResultado(resultado)
            resultado =
                consultaSQL("SELECT * FROM `denuncias` LIMIT " + AtlantaMain.LIMITE_REPORTES + ";", _bdDinamica!!)
            str2 = StringBuilder()
            while (resultado.next()) {
                if (str2.isNotEmpty()) {
                    str2.append("#")
                ...
                str2.append(resultado.getInt("id")).append(";").append(resultado.getString("perso")).append(";")
                    ...
                    .append(
                        if (cuenta.tieneReporte(
                                Constantes.REPORTE_DENUNCIAS, resultado
                                    .getInt("id")
                            )
                        )
                            1
